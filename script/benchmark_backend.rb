...
result = DuoRoute::Runner.new(providers_data: bundle["providers"], operations: bundle["operations"], history:, config:, seed: 42, audit_level: ENV.fetch("AUDIT_LEVEL", "submission")).call
